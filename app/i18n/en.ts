  ...
  mixture: {
    ...
    scenarios: {
      ...
      cruise: {
        ...
        explain:
          "Find the ideal mixture. Lean slowly and watch the EGT climb to its peak, then enrich until it drops about 50°F, two tick marks, back down the rich side. That is 50°F rich of peak. The yellow bug is there to help: park it on the peak with the bezel knob so you can see the 50°F as you enrich.",
      },
      shutdown: {
        title: "Shutdown",
        scene: "Back at the ramp after the flight. Engine idling, mixture still leaned from the taxi in.",
        explain:
          "Time to stop the engine. On a carbureted 150 you do not kill it with the key, you starve it of fuel: pull the mixture all the way out to IDLE CUT-OFF. The engine runs down clean, with no fuel left in the cylinders, and only then do you turn the magnetos off.",
      },
    },
    feedback: {
      ...
      stillLean: "Lean of the peak. Enrich back toward the rich side.",
      leanToRop: "Almost there. Enrich slightly to about 50°F rich of peak.",
      tooFarRich: "Too rich. Lean toward the peak.",
      cutoffPull: "Pull the mixture all the way out to idle cut-off.",
      okTaxi: "✓ LEANED FOR TAXI",
      okTakeoffLanding: "✓ FULL RICH",
      okCruise: "✓ 50°F RICH OF PEAK",
      okShutdown: "✓ IDLE CUT-OFF, ENGINE STOPPED",
    },
    retry: "New target",
