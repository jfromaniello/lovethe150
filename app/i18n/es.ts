  ...
  mixture: {
    ...
    scenarios: {
      ...
      cruise: {
        ...
        explain:
          "Encontrá la mezcla ideal. Empobrecé despacio y mirá la EGT subir hasta el pico, después enriquecé hasta que baje unos 50°F, dos marcas, por el lado rico. Eso es 50°F rich of peak. El bug amarillo está para ayudarte: paralo en el pico con el knob del bisel así ves los 50°F mientras enriquecés.",
      },
      shutdown: {
        title: "Apagado",
        scene: "De vuelta en plataforma después del vuelo. Motor en ralentí, la mezcla todavía leaneada del carreteo de entrada.",
        explain:
          "Hora de parar el motor. En un 150 carburado no lo apagás con la llave, lo dejás sin combustible: tirá la mezcla del todo hasta IDLE CUT-OFF. El motor se apaga limpio, sin combustible en los cilindros, y recién después cortás los magnetos.",
      },
    },
    feedback: {
      ...
      stillLean: "Del lado pobre del pico. Enriquecé hacia el lado rico.",
      leanToRop: "Casi. Enriquecé un poco para quedar a unos 50°F rich of peak.",
      tooFarRich: "Demasiado rica. Empobrecé hacia el pico.",
      cutoffPull: "Tirá la mezcla del todo hasta idle cut-off.",
      okTaxi: "✓ LEANEADA PARA CARRETEO",
      okTakeoffLanding: "✓ FULL RICH",
      okCruise: "✓ 50°F RICH OF PEAK",
      okShutdown: "✓ IDLE CUT-OFF, MOTOR PARADO",
    },
